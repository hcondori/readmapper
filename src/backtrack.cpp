...
{
    int16_t d_mask  = 0B0000000000000011; //diagonal
    int16_t bl_mask = 0B0000000000000001; //begin left
    int16_t bu_mask = 0B0000000000000010; //begin up
    int16_t cl_mask = 0B0000000000000100; //continue left
    int16_t cu_mask = 0B0000000000001000; //continue up
